...
class CreaturesControllerTest < ActionController::TestCase
  ...
  test "should create creature" do
    assert_difference('Creature.count') do
      post :create, creature: { description: @creature.description, element: @creature.element, name: @creature.name, sprite: @creature.sprite }
    end
  ...
  test "should update creature" do
    patch :update, id: @creature, creature: { description: @creature.description, element: @creature.element, name: @creature.name, sprite: @creature.sprite }
    assert_redirected_to creature_path(assigns(:creature))
  end
